...
def parse_args():
    ...
    parse.add_argument('--local_space_scale', type=int, default=0, help='local space sample scale K')
    parse.add_argument('--local_gamma', type=float, default=1.0, help='gamma for local space scale')
    ...
    parse.add_argument('--tau', type=float, default=0.25)
    parse.add_argument('--align_z', type=int, default=1, choices=[1, 2, 3, 4])
